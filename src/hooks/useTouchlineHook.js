// src/hooks/useTouchlineContract.js
import { useState, useEffect } from 'react';
import { ethers } from 'ethers';

const Touchline_HOOK_ADDRESS = "0x3C39ee3BC1c49f9323cEE20EE736e84A6b831d61";

const Touchline_HOOK_ABI = [
...
export const useTouchlineContract = () => {
  ...
  useEffect(() => {
    const initContract = async () => {
      ...
      if (!provider) {
        setError("No wallet detected. Please install Phantom Wallet, MetaMask, or another Web3 wallet.");
        return;
      }
      ...
      try {
        ...
        if (window.Phantomwallet && provider === window.Phantomwallet) {
        ...
        console.log("✅ Contract connected to:", Touchline_HOOK_ADDRESS);
